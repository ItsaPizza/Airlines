...
namespace Library
{
    ...
    {
        private List<AircraftModel> aircraftModels { get; set; } = new List<AircraftModel>();
        ...
        public List<AircraftModel> Retrieve() => aircraftModels;


        public AircraftModel Retrieve(int aircraftModelId)
        {
            var aircraftModel = aircraftModels.FirstOrDefault(x => x.Id == aircraftModelId);
